...
func (o *GetRepositoryURL) Build() (*url.URL, error) {
	...
	var _path = "/repositories/{owner}/{name}"

	name := o.Name
	if name != "" {
		_path = strings.Replace(_path, "{name}", name, -1)
	} else {
		return nil, errors.New("Name is required on GetRepositoryURL")
	}
	...
	if owner != "" {
		...
		return nil, errors.New("Owner is required on GetRepositoryURL")
	}
